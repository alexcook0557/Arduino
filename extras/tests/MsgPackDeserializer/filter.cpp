    ...
    SECTION("Filter = {arronly:[{measure:true}],include:true}") {
      ...
      SECTION("include array 32") {
        ...
        CHECK(spy.log() ==
              AllocatorLog{
                  Allocate(sizeofString("onlyarr")),
                  Allocate(sizeofPool()),
                  Allocate(sizeofString("location")),    // ಠ_ಠ
                  Deallocate(sizeofString("location")),  // ಠ_ಠ
                  Allocate(sizeofString("measure")),
                  Allocate(sizeofString("location")),    // ಠ_ಠ
                  Deallocate(sizeofString("location")),  // ಠ_ಠ
                  Allocate(sizeofString("include")),
                  Allocate(sizeofString("measure")),
                  Deallocate(sizeofString("measure")),
                  Reallocate(sizeofPool(), sizeofObject(2) + sizeofArray(2) +
                                               2 * sizeofObject(1)),
              });
      }
      ...
      SECTION("skip fixmap") {
        ...
        CHECK(spy.log() == AllocatorLog{
                               Allocate(sizeofString("onlyarr")),
                               Allocate(sizeofPool()),
                               Allocate(sizeofString("one")),    // ಠ_ಠ
                               Deallocate(sizeofString("one")),  // ಠ_ಠ
                               Allocate(sizeofString("two")),    // ಠ_ಠ
                               Deallocate(sizeofString("two")),  // ಠ_ಠ
                               Allocate(sizeofString("include")),
                               Reallocate(sizeofPool(), sizeofObject(2)),
                           });
      }
      ...
      SECTION("skip map 16") {
        ...
        CHECK(spy.log() == AllocatorLog{
                               Allocate(sizeofString("onlyarr")),
                               Allocate(sizeofPool()),
                               Allocate(sizeofString("H")),    // ಠ_ಠ
                               Deallocate(sizeofString("H")),  // ಠ_ಠ
                               Allocate(sizeofString("W")),    // ಠ_ಠ
                               Deallocate(sizeofString("W")),  // ಠ_ಠ
                               Allocate(sizeofString("include")),
                               Reallocate(sizeofPool(), sizeofObject(2)),
                           });
      }
      ...
      SECTION("skip map 32") {
        ...
        CHECK(spy.log() == AllocatorLog{
                               Allocate(sizeofString("onlyarr")),
                               Allocate(sizeofPool()),
                               Allocate(sizeofString("zero")),    // ಠ_ಠ
                               Deallocate(sizeofString("zero")),  // ಠ_ಠ
                               Allocate(sizeofString("pi")),      // ಠ_ಠ
                               Deallocate(sizeofString("pi")),    // ಠ_ಠ
                               Allocate(sizeofString("include")),
                               Reallocate(sizeofPool(), sizeofObject(2)),
                           });
      }
    ...
    SECTION("include fixmap") {
      ...
      CHECK(spy.log() ==
            AllocatorLog{
                ...
                Deallocate(sizeofString("location")),
                Allocate(sizeofString("measure")),
                Allocate(sizeofString("include")),
